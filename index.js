const sumOfFutureProfit = require("./lib/SumOfFutureProfit.js");
...
const sumOfSoldItems = require("./lib/profit.js");
...
(async () => {
    ...
    const profit = sumOfSoldItems(goodsInfo);
    const futureProfit = sumOfFutureProfit(goodsInfo);
    ...
    console.log(`- suprekiauta suma: ${profit} ${currency}`);
    console.log(`- galimu pardavimu: ${futureProfit} ${currency}`);
    console.log(`- maksimalus galima parduotuves apyvarta: ${futureProfit + profit} ${currency}`);
})();
